      ...
      <div className="relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              {[
                { icon: MapPin, title: "Location", content: "San Francisco, CA", color: "blue" },
                { icon: Phone, title: "Phone", content: "+1 (555) 123-4567", color: "purple" },
                { icon: Mail, title: "Email", content: "your.email@example.com", color: "pink" }
              ].map((item, index) => (
                <motion.div
                  key={item.title}
                  variants={itemVariants}
                ...
                >
                  <div className={`absolute inset-0 bg-gradient-to-br from-${item.color}-50 to-${item.color}-100 dark:from-${item.color}-900/20 dark:to-${item.color}-800/20 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300`}></div>
                  <div className="relative flex items-center space-x-4">
                    <div className={`w-12 h-12 rounded-full bg-${item.color}-100 dark:bg-${item.color}-900/50 flex items-center justify-center`}>
